        ...
        <div class="container-fluid my-2">
            <div class="row mb-2">
                ...
                <div class="col-sm-6 text-right">
                    <a href="/admin/products/index" class="btn btn-primary">Back</a>
                </div>
            </div>
        </div>
        <!-- /.container-fluid -->
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    if (response['status'] == true) {
                        ...
                        if (errors['brand']) {
                            $("#brand").addClass('is-invalid').siblings('p').addClass('invalid-feedback')
                                .html(errors['brand']);
                        } else {
                            $("#brand").removeClass('is-invalid').siblings('p').removeClass(
                                'invalid-feedback').html("");
                        }

                        if (errors['sku']) {
                            $("#sku").addClass('is-invalid').siblings('p').addClass('invalid-feedback')
                                .html(errors['sku']);
                        } else {
                        ...
                        if (errors['qty']) {
                            $("#qty").addClass('is-invalid').siblings('p').addClass('invalid-feedback')
                                .html(errors['qty']);
                        } else {
