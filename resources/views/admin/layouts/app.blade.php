		...
		<div class="wrapper">
				...
				<ul class="navbar-nav ml-auto">
					...
					<li class="nav-item dropdown">
						...
						<div class="dropdown-menu dropdown-menu-lg dropdown-menu-right p-3">
							...
							<div class="dropdown-divider"></div>
							<a href="{{ asset('admin/logout')}}" class="dropdown-item text-danger">
			...
			<aside class="main-sidebar sidebar-dark-primary elevation-4">
				...
				<a href="#" class="brand-link">
					...
					<span class="brand-text font-weight-light">Bachat Bazaar</span>
				</a>
				<!-- Sidebar -->
				<div class="sidebar">
					...
					<nav class="mt-2">
						<ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
							...
							<li class="nav-item">
								<a href="/admin/sub-category/index" class="nav-link">
									<i class="nav-icon fas fa-file-alt"></i>
									<p>Sub Category</p>
								</a>
							</li>
							...
							<li class="nav-item">
								<a href="/admin/shipping/create" class="nav-link">
									<!-- <i class="nav-icon fas fa-tag"></i> -->
			...
			<footer class="main-footer">
				...
				<strong>Copyright &copy; 2023-24 Dollop Info Tech PVT LTD All rights reserved.
			</footer>
