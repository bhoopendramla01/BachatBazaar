                                            ...
                                            <select name="country" id="country" class="form-control">
                                                ...
                                                @if ($countries->isNotEmpty())
                                                    @foreach ($countries as $country)
                                                        <option {{ (!empty($customerAddress) && $country->id == $customerAddress->country_id) ? 'selected' : ''}} value="{{ $country->id }}">{{ $country->name }}</option>
                                                    @endforeach
                                                @endif
                                            </select>
                                            <p></p>
                                    ...
                                    <div class="col-md-12">
                                        <div class="mb-3">
                                            <input type="text" name="phone" id="phone" class="form-control"
                                                placeholder="Mobile No." value="{{ (!empty($customerAddress)) ? $customerAddress->phone : ''}}">
                                                <p></p>
                                        </div>
                                    </div>
...
@section('customJs')
    <script type="text/javascript">
        ...
        $("#orderForm").submit(function(event) {
            ...
            $.ajax({
                url: '{{ route('account/processCheckout') }}',
                type: 'post',
                ...
                success: function(response) {
                    ...
                    if (response['status'] == true) {
                        ...
                        window.location.href = "{{ route('account/thankYou') }}";
