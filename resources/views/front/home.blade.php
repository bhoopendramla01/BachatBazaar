...
@section('content')
    ...
    <section class="section-4 pt-5">
        <div class="container">
            ...
            <div class="row pb-3">
                @if (Helper::isFeatured()->isNotEmpty())
                    @foreach (Helper::isFeatured() as $is_featured)
                        <div class="col-md-3">
                            <div class="card product-card">
                                <div class="product-image position-relative">
                                    @if ($is_featured->product_images->isNotEmpty())
                                        @php
                                ...
                                <div class="card-body text-center mt-3">
                                    <a class="h6 link" href="product.php">{{ $is_featured->title }}</a>
                                    <div class="price mt-2">
                                        <span class="h5"><strong>{{ $is_featured->price }}</strong></span>
                                        <span
                                            class="h6 text-underline"><del>{{ $is_featured->compare_price }}</del></span>
                                    </div>
                                </div>
                            </div>
                        </div>
    ...
    <section class="section-4 pt-5">
        <div class="container">
            ...
            <div class="row pb-3">
                @if (Helper::isLatest()->isNotEmpty())
                    @foreach (Helper::isLatest() as $is_latest)
                        <div class="col-md-3">
                            <div class="card product-card">
                                <div class="product-image position-relative">
                                    @if ($is_latest->product_images->isNotEmpty())
                                        @php
                                ...
                                <div class="card-body text-center mt-3">
                                    <a class="h6 link" href="product.php">{{ $is_latest->title }}</a>
                                    <div class="price mt-2">
                                        <span class="h5"><strong>{{ $is_latest->price }}</strong></span>
                                        <span class="h6 text-underline"><del>{{ $is_latest->compare_price }}</del></span>
                                    </div>
                                </div>
                            </div>
                        </div>
