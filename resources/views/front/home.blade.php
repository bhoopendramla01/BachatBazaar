            ...
            <div class="row align-items-center py-3 d-none d-lg-flex justify-content-between">
                <div class="col-lg-4 logo">
                    <a href="index.php" class="text-decoration-none">
                        <span class="h1 text-uppercase text-primary bg-dark px-2">Bachat</span>
                        <span class="h1 text-uppercase text-dark bg-primary px-2 ml-n1">Bazaar</span>
                    </a>
                </div>
                                ...
                                <div class="card product-card">
                                    ...
                                    <div class="card-body text-center mt-3">
                                        ...
                                        <div class="price mt-2">
                                            ...
                                            <span class="h6 text-underline"><del>{{ $is_featured->compare_price }}</del></span>
                                        </div>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="row">
                    <div class="col-12 mt-3">
                        <div class="copy-right text-center">
                            <p>© Copyright 2023-24 Dollop Info Tech PVT LTD All rights reserved.</p>
                        </div>
                    </div>
                </div>
            </div>
